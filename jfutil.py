...
def format_report_by_process(params, event_freqs):
	jfutil.debug(params['verbose'], 'Generating report')
	report = []
...
def out_file(params, report):
	jfutil.debug(params['verbose'], 'Writing to file {}'.format(params['write-file']))
...
def import_conf(params):
	jfutil.debug(params['verbose'], 'Importing configuration file')
